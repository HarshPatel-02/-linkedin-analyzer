...
from services.ai_service import generate_chat_suggestions, get_pitch_config, save_pitch_config
...
async def suggest_messages(data: SuggestRequest):
    """✨ popup: AI next-message suggestions from the last 5 chat messages."""
    try:
        profile = {
            "name":            data.name,
